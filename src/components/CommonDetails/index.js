          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-10 flex flex-col items-center justify-between space-y-4 botder-t border-b py-4 sm:flex-row sm:space-y-0">
              ...
              <button
                ...
                className="mt-1.5 inline-block bg-blue-800 px-5 py-3 text-xs font-medium tracking-wide uppercase text-white transition-all duration-200 hover:bg-blue-700 rounded-xl"
              >
            ...
            <div className="lg:col-span-3">
              <div className="border-b border-gray-400">
                <nav className="flex gap-4">
                  <a
                    href="#"
                    className="border-b-2 border-gray-900 py-4 text-sm font-medium text-black"
                  >
                    Description
                  </a>
                </nav>
