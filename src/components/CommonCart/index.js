                        ...
                        <div className="flex flex-1 flex-col justify-between">
                          <div className="sm:col-gap-5 sm:grid sm:grid-cols-2">
                            ...
                            <div className="mt-4 flex gap-3 items-end justify-between sm:mt-0 sm:items-start sm:justify-end">
                              ...
                              <button
                                type="button"
                                className="font-medium transition-all duration-200 text-red-700 sm:order-2 hover:text-red-500"
                                onClick={() =>
              ...
              <div className="mt-6 border-t border-b py-2">
                ...
                <div className="mt-5 text-center">
                  ...
                  onClick={()=>router.push('/checkout')}
                    ...
                    className="disabled:opacity-50 group inline-flex w-full items-center justify-center bg-blue-800 rounded-xl transition-all duration-200 px-6 py-4 text-lg text-white font-medium uppercase tracking-wider hover:bg-blue-700"
                  >
                    Checkout
                  </button>
                </div>
