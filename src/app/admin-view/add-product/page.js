      ...
      <div className="flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl relative text-black">
        <div className="w-full mt-6 mr-0 mb-0 ml-0 space-y-8">
          ...
          <button
            ...
            className="inline-flex w-full items-center justify-center rounded-xl bg-green-800 px-6 py-4 text-lg text-white font-medium uppercase tracking-wider hover:bg-green-700"
          >
